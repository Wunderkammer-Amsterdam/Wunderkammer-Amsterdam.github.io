...
interface SectionImpressionsArgs {
  advanceDelay: Number;
}

export default class SectionImpressions extends Component<SectionImpressionsArgs> {
  advanceDelay: Number = 4500;
  @tracked currentIndex: Number = 0;
